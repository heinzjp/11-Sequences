...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([1, 2, 10, -12, 56, 4])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 65
    actual = sum_first_n([55, -10, 20, 2], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = -30
    actual = sum_first_n([50, -80, 50, 5], 2)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
